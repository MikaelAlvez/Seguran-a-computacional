...
public class ServidorCalc1 {
    private static final String ENDERECO = "192.168.0.10"; // Simulado
    private static final int PORTA = 6100;
    ...
    public static void main(String[] args) throws Exception {
        ...
        String msg = "REGISTER soma " + ENDERECO;
